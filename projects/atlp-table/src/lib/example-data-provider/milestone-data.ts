import { AtlpGraphData } from 'projects/@atlp/components/@v2/atlp-transaction-milestone/models/atlp-transaction-milestone-graph-response.model';
import { BaseResponse } from 'projects/@atlp/core/models/baseResponse.model';

export const atlp_example_milestone_static_data: BaseResponse<AtlpGraphData> = {
  data: {
    GraphTitle: '',
    GraphData: [
      {
