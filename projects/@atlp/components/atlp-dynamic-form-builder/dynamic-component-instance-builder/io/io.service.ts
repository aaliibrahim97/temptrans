...
import { AtlpDynamicComponentInjector } from '../component-injector';
...
export class IoService implements OnDestroy {
  ...
  private compInjector: AtlpDynamicComponentInjector;
  ...
  init(
    componentInjector: AtlpDynamicComponentInjector,
