...
@Directive({
  selector: '[atlpDynamicAttributes],[ngComponentOutletatlpDynamicAttributes]',
  exportAs: 'atlpDynamicAttributes',
})
export class AtlpDynamicAttributesDirective implements DoCheck {
  @Input()
  atlpDynamicAttributes: AttributesMap;
  @Input()
  ngComponentOutletatlpDynamicAttributes: AttributesMap;
  ...
  private get _attributes() {
    return (
      this.atlpDynamicAttributes || this.ngComponentOutletatlpDynamicAttributes
    );
  }
