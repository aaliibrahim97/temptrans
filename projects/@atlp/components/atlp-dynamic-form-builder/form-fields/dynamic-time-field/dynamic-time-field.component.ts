...
@Component({
  selector: 'dynamic-time-field',
  templateUrl: './dynamic-time-field.component.html',
  styleUrls: ['./dynamic-time-field.component.scss'],
})
export class DynamicTimeFieldComponent
