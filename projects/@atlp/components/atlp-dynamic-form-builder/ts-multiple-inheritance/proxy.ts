 ...
 */
export const getIngredientWithProp = (
 ...
 */
export const proxyMix = (ingredients: any[], prototype = Object.prototype) =>
  new Proxy(
    {},
    {
      getPrototypeOf() {
      ...
      ownKeys() {
        return ingredients
          ...
          .reduce((prev, curr) =>
            curr.concat(prev.filter((key) => curr.indexOf(key) < 0))
          );
      },
    }
  );
 ...
 */
export const softMixProtos = (
  ingredients: any[],
  constructor: Function
): object => proxyMix([...ingredients, { constructor }]);
