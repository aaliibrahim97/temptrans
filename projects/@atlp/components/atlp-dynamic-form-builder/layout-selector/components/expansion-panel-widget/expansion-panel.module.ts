...
import { DynamicFormAccordionComponent } from './components/dynamic-form-accordion/dynamic-form-accordion.component';
import { DynamicExpansionPanelComponent } from './components/expansion-panel.component';

@NgModule({
  declarations: [DynamicFormAccordionComponent, DynamicExpansionPanelComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class DynamicExpansionPanelModule {}
