...
@UntilDestroy()
@Component({
  selector: 'app-payment-success-or-failure-dialog-v2',
...
export class PaymentSuccessOrFailureDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log('app-payment-success-or-failure-dialog-v2');
...
`;
  ...
  close(evt) {
    ...
    this.toggleSidebarOpen(SidebarName.choosePaymentMethodV2);
