export function atlpMethodFactory<T>(
  wrapper: (...a: any[]) => T,
...
export function atlpMethodFactoryBind<T>(
  wrapper: (...a: any[]) => T,
  propertyKey: string,
  descriptor: TypedPropertyDescriptor<T>
) {
  ...
  const func = function (f: () => T) {
    return function (...a: any[]) {
      this[PROP_KEY_SYMBOLS] =
        this[PROP_KEY_SYMBOLS] || wrapper.call(this, f.bind(this));
      return typeof this[PROP_KEY_SYMBOLS] === 'function'
        ? this[PROP_KEY_SYMBOLS].apply(this, a)
        : this[PROP_KEY_SYMBOLS];
    };
  };
