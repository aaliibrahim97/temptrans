...
import { AtlpSidebarV2Service } from './atlp-sidebar.service';

@Component({
  selector: 'atlp-sidebar-v2',
  templateUrl: './atlp-sidebar.component.html',
  styleUrls: ['./atlp-sidebar.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class AtlpSidebarV2Component implements OnInit, OnDestroy {
  ...
  // Invisible overlay
  @Input()
  invisibleOverlay: boolean = false;
  ...
  @Output() onSidebarClose = new EventEmitter<any>();

  @Input()
  conformationMessage: boolean;
  ...
  constructor(
    ...
    private _atlpSidebarService: AtlpSidebarV2Service,
  ...
  toggleSidebarOpen() {
    if (!this.conformationMessage) {
      this.onSidebarClose.emit('closed');
      this._atlpSidebarService.getSidebar(this.name).toggleOpen();
    } else {
      this.onSidebarClose.emit('confirmation');
    }
  }
  ...
  resizePannel() {
    ...
    // if (this.maximize) {
    //   this._renderer.addClass(this._elementRef.nativeElement, 'sidebar-large');
    //   this._renderer.removeClass(
    //     this._elementRef.nativeElement,
    //     'sidebar-medium'
    //   );
    // } else {
    //   this._renderer.addClass(this._elementRef.nativeElement, 'sidebar-medium');
    //   this._renderer.removeClass(
    //     this._elementRef.nativeElement,
    //     'sidebar-large'
    //   );
  ...
  ngOnInit(): void {
    this.openedSidebar = this._atlpSidebarService.allOpenedSidebar;
  ...
  private get icons(): Array<string> {
    return ['dark-light', 'icon-collapse', 'icon-expand', 'icon-close-dark'];
  }
