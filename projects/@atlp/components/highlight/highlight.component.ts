...
import 'projects/@atlp/components/highlight/prism-languages';

@Component({
  selector: 'atlp-highlight',
  template: '',
  styleUrls: ['./highlight.component.scss'],
})
export class AtlpHighlightComponent implements OnInit, OnDestroy {
  // Source
  ...
  highlight(sourceCode): void {
    ...
    // can be formatted properly while using atlp-highlight
    // component
