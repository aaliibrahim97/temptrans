...
@Component({
  selector: 'app-matrix-small',
  templateUrl: './matrix-small.component.html',
  styleUrls: ['./matrix-small.component.scss'],
})
export class MatrixSmallComponent implements OnInit, AfterViewInit, OnDestroy {
  @Input() chartId = null;
  labelyColor = '#8F9AB3';
  labelxColor = '#8E9AAF';
