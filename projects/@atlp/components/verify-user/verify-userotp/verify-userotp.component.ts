...
import { EmailVerificationModel } from '../../mfa/EmailVerificationModels';
import { processErrors } from 'projects/@atlp/core/helpers/process-errors.helper';

//test
@UntilDestroy()
@Component({
  selector: 'atlp-verify-userotp',
  templateUrl: './verify-userotp.component.html',
  styleUrls: ['./verify-userotp.component.scss'],
})
export class VerifyUserOTPComponent implements OnInit, OnDestroy, OnChanges {
  ...
  constructor(
    ...
    private emailotpservice: UserEmailOTPService,
