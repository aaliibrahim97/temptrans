...
export class AtlpInnerScrollDirective implements OnInit, OnDestroy {
  // Private
  private _parent: any;
   ...
   * @param {AtlpMatchMediaService} _atlpMediaMatchService
   * @param {Renderer2} _renderer
   */
  constructor(
    private _elementRef: ElementRef,
    private _atlpMediaMatchService: AtlpMatchMediaService,
  ...
  ngOnInit(): void {
    ...
    this._atlpMediaMatchService.onMediaChange
